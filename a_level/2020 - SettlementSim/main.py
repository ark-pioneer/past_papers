...
class Simulation:
  ...
  def AddCompany(self):
    ...
    while True:
      ...
      if CompanyName == "":
        print("Sorry, pls enter a name")
      elif self.GetIndexOfCompany(CompanyName) != -1:
        print("Sorry, pls provide unique name")
      else:
        break
  ...
  def ModifyCompany(self, Index):
    ...
    if Choice == "2" or Choice == "3":
      ...
      company.GetLoan(rate)
    elif Choice == "5":
      payment_amount = int(input("enter payment: "))
      company = self._Companies[Index]
      company.PayLoan(payment_amount)
    print()
